...
execute_process(
  COMMAND "/usr/bin/git" show-ref 355f42497a9cd17d16ae91da1f1aaaf93756ae8b
  WORKING_DIRECTORY "/home/yuanyao/pyscf_my/pyscf/lib/build/deps/src/libxcfun"
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 355f42497a9cd17d16ae91da1f1aaaf93756ae8b
  WORKING_DIRECTORY "/home/yuanyao/pyscf_my/pyscf/lib/build/deps/src/libxcfun"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/dftlibs/xcfun.git'")
  endif()
